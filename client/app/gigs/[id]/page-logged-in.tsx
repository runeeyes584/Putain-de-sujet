...
export default function GigDetailsLoggedIn({ params }) {
    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: gig.title,
          text: `Check out this awesome gig: ${gig.title}`,
                ...
                <TabsContent value="basic">
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <PriceDisplay amount={gig.packages.basic.price} className="text-lg font-bold" />
                    </div>
                ...
                <TabsContent value="standard">
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <PriceDisplay amount={gig.packages.standard.price} className="text-lg font-bold" />
                    </div>
                ...
                <TabsContent value="premium">
                  <div className="space-y-4">
                    <div className="flex justify-between">
                      ...
                      <PriceDisplay amount={gig.packages.premium.price} className="text-lg font-bold" />
                    </div>
          ...
          <div className="rounded-xl border bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              {relatedGigs.map((relatedGig) => (
                <ServiceCard key={relatedGig.id} service={relatedGig} />
              ))}
            </div>
          </div>
        </div>
            ...
            <Tabs defaultValue="basic" value={selectedPackage} onValueChange={setSelectedPackage} className="w-full">
              ...
              <TabsContent value="basic" className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold">Basic Package</h3>
                  <PriceDisplay amount={gig.packages.basic.price} className="text-xl font-bold" />
                </div>
                <p className="text-gray-600 dark:text-gray-300">{gig.packages.basic.description}</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
              ...
              <TabsContent value="standard" className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold">Standard Package</h3>
                  <PriceDisplay amount={gig.packages.standard.price} className="text-xl font-bold" />
                </div>
                <p className="text-gray-600 dark:text-gray-300">{gig.packages.standard.description}</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
              ...
              <TabsContent value="premium" className="space-y-4">
                <div className="flex items-center justify-between">
                  <h3 className="text-lg font-semibold">Premium Package</h3>
                  <PriceDisplay amount={gig.packages.premium.price} className="text-xl font-bold" />
                </div>
                <p className="text-gray-600 dark:text-gray-300">{gig.packages.premium.description}</p>
                <div className="flex items-center justify-between">
                  <div className="flex items-center">
